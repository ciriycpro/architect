...
**Status:** DEC-0030 Accepted 23.06.2026. Реализация: новый сервис `summary-prep/` (Python+FastAPI+asyncio), workflow `email_digest_v1` step 4 (distill_attachments), summary-service обновление контракта (DistillResult вместо raw text).
