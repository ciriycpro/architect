...
Mail-stack v1 запущен на одном инстансе coo через systemd. Это работает для **первого клиента**, но не масштабируется на:
...
- Демонстрацию архитектуры в архитектурных обзорах

Также есть **архитектурное обоснование**: возможность сказать «**развернул mail-stack как декларативные K8s-манифесты, тестируется на minikube, готов к GKE**» — это senior-уровень, не «развернул через systemd скрипты».
...
- ✅ Архитектурное обоснование — настоящий K8s в портфолио, не «писал на словах»
