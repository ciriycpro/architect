...
- [DEC-018](../decisions/0018-multi-channel-notification.md): Multi-channel notification — WhatsApp pre-alert + Telegram content delivery. **Implemented 13.05.2026** в Orchestrator v1.0. Архитектурный паттерн «push на одном канале, контент на другом» для UX 24/7. Trade-off на v1.0: 80 секунд sequential delay из-за whatsapp-web.js destroy timing — на v1.3 parallel goroutine. На v3 — переход на WhatsApp Business API (платно, enterprise-grade).
